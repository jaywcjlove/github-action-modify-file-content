...
Here is the example: update time <!--GAMFC-->2025-12-03 15:56:17<!--GAMFC-END-->
...
| `openDelimiter`   | ❌        | `<!--GAMFC-->2025-12-03 15:56:17<!--GAMFC-END-->`                             | End delimiter for content replacement. |
...
```markdown
update time <!--GAMFC-->2025-12-03 15:56:17<!--GAMFC-END-->
```

Replace the content between `<!--GAMFC-->2025-12-03 15:56:17<!--GAMFC-END-->`.
