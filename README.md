...
Here is the example: update time <!--GAMFC-->2026-04-21 09:30:46<!--GAMFC-END-->
...
| `openDelimiter`   | ❌        | `<!--GAMFC-->2026-04-21 09:30:46<!--GAMFC-END-->`                             | End delimiter for content replacement. |
...
```markdown
update time <!--GAMFC-->2026-04-21 09:30:46<!--GAMFC-END-->
```

Replace the content between `<!--GAMFC-->2026-04-21 09:30:46<!--GAMFC-END-->`.
